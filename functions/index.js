...
var serviceAccount = require("./magyarorszagmap-firebase-adminsdk-cgvek-f668a50a3d.json");
const { LOG_ERROR } = require("karma/lib/constants");

admin.initializeApp({
  credential: admin.credential.cert(serviceAccount),
  databaseURL: "https://magyarorszagmap-default-rtdb.europe-west1.firebasedatabase.app"
});
